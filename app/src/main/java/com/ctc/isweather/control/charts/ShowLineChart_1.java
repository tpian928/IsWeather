 ...
 */
public class ShowLineChart_1 extends Activity implements SeekBar.OnSeekBarChangeListener, OnChartGestureListener, OnChartValueSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("Hello world");
        mChart.setNoDataTextDescription("No data");

        // enabale value highlighting
        mChart.setHighlightEnabled(true);

        // enable touch gestuer
